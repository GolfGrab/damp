...
import NotificationList from "@/modules/notification-center/NotificationList";
import { type NotificationPreviewContent } from "@/modules/notification-center/types";
...
const Home = () => {
  ...
  return <NotificationList notifications={testNotifications} />;
};
